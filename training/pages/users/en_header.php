        ...
        <img src="../../images/log.png" alt="Internsport Logo" id="logo" style="height: 90px;width:120px;"class="navbar-brand-rgiht"/>
                ...
                <div class="collapse navbar-collapse ml-auto" id="navbarNavAltMarkup">
                    ...
                    <div class="navbar-nav ml-auto" style="padding-top: 10px;padding-left:480px; ">
                        ...
                        <a class="nav-link " aria-current="page" href="registed_room.php">Registed Room</a>
                        <a class="nav-link " aria-current="page" href="index.php">Home </a>
                        <form action ="" method="POST" >
                             <input type="text" name="userid" style="text-align:center;" placeholder="Enter User ID"/>
                             <input type="submit" name="search" value="Search ">
                        </form>
                    
                    </div>
                </div>
                <a class="nav-link " aria-current="page" href="arapic_index.php"> <img src="../../images/EN.png" alt="Internsport Logo" id="logo" style="height: 26px;width:26px;margin:10px;" /></a>
